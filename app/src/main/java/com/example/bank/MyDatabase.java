...
public class MyDatabase extends SQLiteOpenHelper {
    ...
    public void intiData(SQLiteDatabase database) {
        User user = new User("Ali", "ali@gmail.com", 500);
        insertUser(user, database);
        user = new User("Abdo", "abdo@gmail.com", 50000);
        insertUser(user, database);
        user = new User("Saad", "saad@gmail.com", 500);
        insertUser(user, database);
        user = new User("Alaa", "alaa@gmail.com", 500);
        insertUser(user, database);
        user = new User("Sara", "sara@gmail.com", 500);
        insertUser(user, database);
        user = new User("Nada", "nada@gmail.com", 500);
        insertUser(user, database);
        user = new User("Mohamed", "mohamed@gmail.com", 500);
        insertUser(user, database);
        user = new User("Ahmed", "ahmed@gmail.com", 500);
        insertUser(user, database);
        user = new User("Said", "said@gmail.com", 500);
        insertUser(user, database);
        user = new User("Salah", "salah@gmail.com", 1500);
        insertUser(user, database);
    }
